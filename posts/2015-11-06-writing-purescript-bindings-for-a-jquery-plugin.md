...
interface. It's worth noting that we're using the FFI style introduced in
[PureScript 0.7](https://github.com/purescript/purescript/wiki/0.7-Migration-Guide#no-more-inline-ffi-code).
